...
--
-- Administration User for the schema `188`
--

DROP USER IF EXISTS '188'@'localhost';
CREATE USER '188'@'localhost' IDENTIFIED BY '188' PASSWORD EXPIRE NEVER;
GRANT ALL ON `188`.* TO '188'@'localhost';
GRANT SELECT, INSERT ON `188`.* TO '188'@'localhost';
